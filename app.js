    ...
    return new Promise(function(resolve, reject) {
        ...
        if (card.getAttribute("selected") == "1") {
            ...
            if (count % 5 == 0) {
                ...
                setTimeout(function() {
                    alert("Congrats..... Completed " + count + " Tasks ");
                }, 10);
...
${title}
                ...
                datainfo.innerHTML = "<div class='mb-3 text-center '>Select your Tasks.</div><div class='d-flex justify-content-center'><div class='row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4'>" + out + "</div></div>";
